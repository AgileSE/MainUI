...
public class GeneratorConfig {
    ...
    private boolean xmlWithMapperCheckBoxChecked;
    ...
    public boolean isXmlWithMapperCheckBoxChecked() {
        return xmlWithMapperCheckBoxChecked;
    }

    public void setXmlWithMapperCheckBoxChecked(boolean xmlWithMapperCheckBoxChecked) {
        this.xmlWithMapperCheckBoxChecked = xmlWithMapperCheckBoxChecked;
    }
}
